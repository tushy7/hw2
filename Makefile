...
OBJS=amazon.o user.o clothing.o book.o movie.o product.o product_parser.o util.o mydatastore.o db_parser.o
...
amazon.o: amazon.cpp  book.h movie.h clothing.h db_parser.h datastore.h product_parser.h mydatastore.h
